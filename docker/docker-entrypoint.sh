...
#                    auto       — try ESP32 then Windows WiFi, then wait for
#                                 hardware. When no real CSI is available at
#                                 startup, reports source: "waiting_for_hardware"
#                                 (issue #1125: no simulator fallback).
