...
15. [RVF Model Containers](#rvf-model-containers)
16. [Hardware Setup](#hardware-setup)
    - [ESP32-S3 Mesh](#esp32-s3-mesh)
    - [Intel 5300 / Atheros NIC](#intel-5300--atheros-nic)
17. [Camera-Free Pose Training](#camera-free-pose-training)
18. [ruvllm Training Pipeline](#ruvllm-training-pipeline)
19. [Docker Compose (Multi-Service)](#docker-compose-multi-service)
20. [Testing Firmware Without Hardware (QEMU)](#testing-firmware-without-hardware-qemu)
