...
test('registry exposes the documented tools with schemas (underscore-canonical)', () => {
  ...
  for (const n of ['ruview_onboard', 'ruview_claim_check', 'ruview_verify', 'ruview_node_monitor', 'ruview_calibrate', 'ruview_node_flash', 'ruview_guidance', 'ruview_nlos_plan', 'ruview_nlos_verify', 'ruview_spaces_list', 'ruview_memory_search']) {
